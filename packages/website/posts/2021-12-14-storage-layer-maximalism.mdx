...
description: SAMPLE DESCRIPTION REPLACE ME
author: Jonathan Victor
thumbnail: /images/blog-2/nyan.png
date: Dec 14, 2021
tags:
  - nft
  - ipfs
...
*Linking*: How do we make sure the link our NFT uses actually points at the thing we want it to represent (aka my NFT is linked to its content, not someone else’s server)?
*Existence*: How do we make sure the link our NFT uses always resolves to the content we expect it to (aka prevent our jpegs from disappearing)?
...
Imagine we were talking about “To Kill A Mockingbird” and you were interested in getting a copy of it. In the way that HTTP URLs work, sharing this book with you would be like describing to you where you could find it (“Come to NYC, at these cross streets you’ll find a library, 3rd bookshelf in - 2 books from the right is the one you want). Naturally, many things can go wrong (you could get blocked from coming to NYC, the library could burn down, a different book could be in the same location you were told to go to, etc). 
