...
**If you’re familiar with how NFTs work what's happening under the hood, skip this section - this is just to get everyone up to speed.**

Many people describe an NFT asIf you ask the average person what an NFT is, they’ll probably tell you it's a picture (or video or something) that “lives on the blockchain”. Because it “lives on the blockchain”, you get all these cool properties (Provenance! Automatic royalties! User ownership!) - which has birthed a whole movement in digital creation.
