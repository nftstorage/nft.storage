...
NFT.Storage [launched our gateway]([https://nft.storage/blog/post/2022-03-08-gateway-release/](https://nft.storage/blog/post/2022-03-08-gateway-release/)) in early March. Adoption accelerated rapidly, with 25 million weekly requests already by the second week. Folks minting Solana Metaplex NFTs (which require HTTP URLs) like Magic Eden started using nftstorage.link URLs that contained the CIDs of the relevant NFT content. Some of the latest numbers include over 155 million requests last week for more than 1000 TB and a >70% cache hit rate.

We also quickly found oversized hammers from the web2 world that were able whole business sectors offline despite due to their mistakes. Despite the proactive security measures in place for gateways, the structure of our web today led to Google alone causing two major service disruptions for us, dozens of our users, and ~10,000,000 of their end-user requests, as well as an ongoing game of whack-a-mole with smaller security vendors.
...
The next day, one of our Google contacts let us know that the relevant team had admitted that they had put in a bad regex statement. We’ve all been there before, but it was still a remarkable lack of care for such a powerful entity (why wasn’t there better testing?), as well as a shocking lack of transparency (why didn’t they let us know?).
