...
author: David Choi, Mikeal Rogers, Alan Shaw, Benjamin Goering
thumbnail: 
date: Jul 7, 2022
tags:
  - ipfs
...
For NFT.Storage in particular, we saw a **99.9% decrease in 5xx errors to uploads**, as well as huge drops in request time and perf variance across the board (**mean from 3-8s to 2-3s, 99th% from 1-10 min to <10s**).

![image](https://user-images.githubusercontent.com/11778450/177436680-dd5e7877-ac47-4b55-a187-d05e934ae07e.png)
<span style={{ display: 'block', textAlign: 'center', fontStyle: 'italic', marginBottom: 20, fontSize: 14 }}>
