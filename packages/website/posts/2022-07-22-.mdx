---
title: 'Rarible integrates with NFT.Storage'
description: 
author: David Choi
thumbnail: ![image](https://user-images.githubusercontent.com/11778450/180139575-f82c333a-235c-44f4-a36f-6339c7c2242e.png)
date: Jul 22, 2022
tags:
  - integration
  - rarible
...
_This post was originally made on the Filecoin blog on July 21, 2022._
...
NFT.Storage’s mission is to be the [“Internet Archive” for NFTs](https://nft.storage/blog/post/2022-01-20-decentralizing-nft-storage/) - making the storage and access of NFTs (from all ecosystems) a public commons. Rarible Protocol, as an open source solution that underpins Rarible.com marketplace, along other NFT projects, has long shared a similar ethos and mission - leading to highly aligned work such as their open source [NFT Indexer](https://docs.rarible.org/overview/indexer/). 
