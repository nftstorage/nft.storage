---
title: 'NFTUp is the easist way to share your NFT content'
description: NFTUp is a downloadable application that makes it simple to upload large directories to NFT.Storage
...
People have been asking for an easy way to drag and drop large directories onto IPFS and NFT.Storage — today we deliver (an alpha version). For most people NFTUp is totally worth using today, but if you have thousands of files, we are working on v2 specifically for you. (It's not that it never works with tons of files, it's just that some people have problems with more than a thousand files in one upload. For them V2 is coming soon, but we didn't want everyone to wait.)
...
* [M1 Mac](https://github.com/nftstorage/nftup/releases/download/v1.0.0-alpha.6/NFT-UP-1.0.0-alpha.6-arm64-mac.zip)
* [Intel Mac](https://github.com/nftstorage/nftup/releases/download/v1.0.0-alpha.6/NFT-UP-1.0.0-alpha.6-mac.zip)
* [Windows](https://github.com/nftstorage/nftup/releases/download/v1.0.0-alpha.6/NFT-UP-Setup-1.0.0-alpha.6.exe)
* [Linux x86](https://github.com/nftstorage/nftup/releases/download/v1.0.0-alpha.6/NFT-UP-1.0.0-alpha.6.dmg)
* [Linux ARM](https://github.com/nftstorage/nftup/releases/download/v1.0.0-alpha.6/NFT-UP-1.0.0-alpha.6-arm64.dmg)
