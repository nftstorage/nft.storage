 ...
 */
export async function servicesStartCmd({ project, clean = false }) {
  ...
  if (clean) {
    cmdOpts.push('--force-recreate')
    cmdOpts.push('--renew-anon-volumes')
  }

  await execa('docker', cmdOpts, { stdio: 'inherit' })
}
