...
GRANT SELECT, UPDATE ON ALL TABLES IN SCHEMA public TO nft_storage;
-- allow access to new tables that are created in the public schema in the future
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, UPDATE ON TABLES TO nft_storage;
