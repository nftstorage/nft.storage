...
(function (blockchain_block_constraint) {
    ...
    blockchain_block_constraint["unique_blockchain_block_hash"] = "unique_blockchain_block_hash";
...
(function (blockchain_contract_constraint) {
    blockchain_contract_constraint["blockchain_contract_pkey"] = "blockchain_contract_pkey";
...
(function (blockchain_contract_select_column) {
    ...
    blockchain_contract_select_column["supports_eip721_metadata"] = "supports_eip721_metadata";
...
(function (blockchain_contract_update_column) {
    ...
    blockchain_contract_update_column["supports_eip721_metadata"] = "supports_eip721_metadata";
...
(function (erc721_token_ingestion_queue_select_column) {
    erc721_token_ingestion_queue_select_column["block_hash"] = "block_hash";
    erc721_token_ingestion_queue_select_column["block_number"] = "block_number";
    erc721_token_ingestion_queue_select_column["contract_id"] = "contract_id";
    erc721_token_ingestion_queue_select_column["contract_name"] = "contract_name";
    erc721_token_ingestion_queue_select_column["contract_supports_eip721_metadata"] = "contract_supports_eip721_metadata";
    erc721_token_ingestion_queue_select_column["contract_symbol"] = "contract_symbol";
    erc721_token_ingestion_queue_select_column["id"] = "id";
    erc721_token_ingestion_queue_select_column["inserted_at"] = "inserted_at";
    erc721_token_ingestion_queue_select_column["mint_time"] = "mint_time";
    erc721_token_ingestion_queue_select_column["owner_id"] = "owner_id";
    erc721_token_ingestion_queue_select_column["token_id"] = "token_id";
...
(function (nft_asset_select_column) {
    ...
    nft_asset_select_column["metadata_cid"] = "metadata_cid";
...
(function (nft_asset_update_column) {
    ...
    nft_asset_update_column["metadata_cid"] = "metadata_cid";
...
(function (nft_metadata_select_column) {
    nft_metadata_select_column["cid"] = "cid";
    ...
    nft_metadata_select_column["json"] = "json";
...
(function (nft_metadata_update_column) {
    nft_metadata_update_column["cid"] = "cid";
    ...
    nft_metadata_update_column["json"] = "json";
...
(function (nfts_by_blockchain_blocks_constraint) {
    nfts_by_blockchain_blocks_constraint["nfts_by_blockchain_blocks_pkey"] = "nfts_by_blockchain_blocks_pkey";
...
(function (nfts_by_blockchain_blocks_select_column) {
    nfts_by_blockchain_blocks_select_column["blockchain_block_hash"] = "blockchain_block_hash";
...
(function (nfts_by_blockchain_blocks_update_column) {
    nfts_by_blockchain_blocks_update_column["blockchain_block_hash"] = "blockchain_block_hash";
...
(function (niftysave_migration_constraint) {
    niftysave_migration_constraint["niftysave_migration_pkey"] = "niftysave_migration_pkey";
...
(function (other_nft_resources_constraint) {
    other_nft_resources_constraint["other_nft_resources_pkey"] = "other_nft_resources_pkey";
...
(function (other_nft_resources_select_column) {
    ...
    other_nft_resources_select_column["metadata_cid"] = "metadata_cid";
...
(function (other_nft_resources_update_column) {
    ...
    other_nft_resources_update_column["metadata_cid"] = "metadata_cid";
...
export const fullChainConstructor = (fn, operation, key) => ((o, options) => fullChainConstruct(fn)(operation, key)(o, options));
const fullSubscriptionConstruct = (fn) => (t, tName) => (o, options) => fn(queryConstruct(t, tName, options?.operationName)(o));
export const fullSubscriptionConstructor = (fn, operation, key) => ((o, options) => fullSubscriptionConstruct(fn)(operation, key)(o, options));
...
export const Zeus = {
    query: (o, operationName) => queryConstruct('query', 'query_root', operationName)(o),
    mutation: (o, operationName) => queryConstruct('mutation', 'mutation_root', operationName)(o),
    subscription: (o, operationName) => queryConstruct('subscription', 'subscription_root', operationName)(o)
};
