...
export type ValueTypes = {
  ...
  /** columns and relationships of "nft_view" */
  ['nft_view']: AliasType<{
    contract_id?: true
    id?: true
    inserted_at?: true
  ...
  /** aggregated selection of "nft_view" */
  ['nft_view_aggregate']: AliasType<{
    aggregate?: ValueTypes['nft_view_aggregate_fields']
    nodes?: ValueTypes['nft_view']
    __typename?: true
  }>
  /** aggregate fields of "nft_view" */
  ['nft_view_aggregate_fields']: AliasType<{
    count?: [
      {
        columns?: ValueTypes['nft_view_select_column'][]
        distinct?: boolean | null
      },
      true
    ]
    max?: ValueTypes['nft_view_max_fields']
    min?: ValueTypes['nft_view_min_fields']
    __typename?: true
  }>
  /** Boolean expression to filter rows from the table "nft_view". All fields are combined with a logical 'AND'. */
  ['nft_view_bool_exp']: {
    _and?: ValueTypes['nft_view_bool_exp'][]
    _not?: ValueTypes['nft_view_bool_exp'] | null
    _or?: ValueTypes['nft_view_bool_exp'][]
    contract_id?: ValueTypes['String_comparison_exp'] | null
    id?: ValueTypes['String_comparison_exp'] | null
    inserted_at?: ValueTypes['timestamptz_comparison_exp'] | null
    mint_time?: ValueTypes['timestamptz_comparison_exp'] | null
  ...
  /** Ordering options when selecting data from "nft_view". */
  ['nft_view_order_by']: {
    contract_id?: ValueTypes['order_by'] | null
    id?: ValueTypes['order_by'] | null
    inserted_at?: ValueTypes['order_by'] | null
...
columns and relationships of "niftysave_migration" */
  ...
  ['query_root']: AliasType<{
    ...
    nft_view?: [
      {
        /** distinct select on columns */
        distinct_on?: ValueTypes['nft_view_select_column'][] /** limit the number of rows returned */
        limit?:
          | number
          | null /** skip the first n rows. Use only with order_by */
        offset?: number | null /** sort the rows by one or more columns */
        order_by?: ValueTypes['nft_view_order_by'][] /** filter the rows returned */
        where?: ValueTypes['nft_view_bool_exp'] | null
      },
      ValueTypes['nft_view']
    ]
    nft_view_aggregate?: [
...
export type ModelTypes = {
  ...
  /** aggregated selection of "nft_view" */
  ['nft_view_aggregate']: {
    aggregate?: ModelTypes['nft_view_aggregate_fields']
    nodes: ModelTypes['nft_view'][]
  }
  /** aggregate fields of "nft_view" */
  ['nft_view_aggregate_fields']: {
    count: number
    max?: ModelTypes['nft_view_max_fields']
    min?: ModelTypes['nft_view_min_fields']
  }
  /** Boolean expression to filter rows from the table "nft_view". All fields are combined with a logical 'AND'. */
  ['nft_view_bool_exp']: GraphQLTypes['nft_view_bool_exp']
  /** aggregate max on columns */
  ['nft_view_max_fields']: {
    contract_id?: string
    id?: string
  ...
  /** Ordering options when selecting data from "nft_view". */
  ['nft_view_order_by']: GraphQLTypes['nft_view_order_by']
  /** select columns of table "nft_view" */
  ['nft_view_select_column']: GraphQLTypes['nft_view_select_column']
  /** columns and relationships of "nfts_by_blockchain_blocks" */
  ['nfts_by_blockchain_blocks']: {
    blockchain_block_hash: string
    inserted_at: ModelTypes['timestamptz']
...
columns and relationships of "niftysave_migration" */
  ...
  ['query_root']: {
    ...
    /** fetch data from the table: "nft_view" */
    nft_view: ModelTypes['nft_view'][]
    /** fetch aggregated fields from the table: "nft_view" */
    nft_view_aggregate: ModelTypes['nft_view_aggregate']
...
export type GraphQLTypes = {
  ...
  /** aggregated selection of "nft_view" */
  ['nft_view_aggregate']: {
    __typename: 'nft_view_aggregate'
    aggregate?: GraphQLTypes['nft_view_aggregate_fields']
    nodes: Array<GraphQLTypes['nft_view']>
  }
  /** aggregate fields of "nft_view" */
  ['nft_view_aggregate_fields']: {
    __typename: 'nft_view_aggregate_fields'
    count: number
    max?: GraphQLTypes['nft_view_max_fields']
    min?: GraphQLTypes['nft_view_min_fields']
  }
  /** Boolean expression to filter rows from the table "nft_view". All fields are combined with a logical 'AND'. */
  ['nft_view_bool_exp']: {
    _and?: Array<GraphQLTypes['nft_view_bool_exp']>
    _not?: GraphQLTypes['nft_view_bool_exp']
    _or?: Array<GraphQLTypes['nft_view_bool_exp']>
    contract_id?: GraphQLTypes['String_comparison_exp']
    id?: GraphQLTypes['String_comparison_exp']
    inserted_at?: GraphQLTypes['timestamptz_comparison_exp']
    mint_time?: GraphQLTypes['timestamptz_comparison_exp']
  ...
  /** aggregate max on columns */
  ['nft_view_max_fields']: {
    __typename: 'nft_view_max_fields'
    contract_id?: string
    id?: string
    inserted_at?: GraphQLTypes['timestamptz']
    mint_time?: GraphQLTypes['timestamptz']
  ...
  /** aggregate min on columns */
  ['nft_view_min_fields']: {
    __typename: 'nft_view_min_fields'
    contract_id?: string
    id?: string
    inserted_at?: GraphQLTypes['timestamptz']
    mint_time?: GraphQLTypes['timestamptz']
...
columns and relationships of "niftysave_migration" */
  ...
  ['query_root']: {
    ...
    /** fetch data from the table: "nft_view" */
    nft_view: Array<GraphQLTypes['nft_view']>
    /** fetch aggregated fields from the table: "nft_view" */
    nft_view_aggregate: GraphQLTypes['nft_view_aggregate']
    /** fetch data from the table: "nfts_by_blockchain_blocks" */
...
/** select columns of table "nft_asset_view" */
export enum nft_asset_view_select_column {
  content_cid = 'content_cid',
  inserted_at = 'inserted_at',
  ipfs_url = 'ipfs_url',
  status = 'status',
...
/** select columns of table "nft_view" */
export enum nft_view_select_column {
  contract_id = 'contract_id',
  id = 'id',
  inserted_at = 'inserted_at',
  mint_time = 'mint_time',
...
/** select columns of table "resource_view" */
export enum resource_view_select_column {
  content_cid = 'content_cid',
  inserted_at = 'inserted_at',
  ipfs_url = 'ipfs_url',
  status = 'status',
