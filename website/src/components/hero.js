      ...
      <div className='center mw9 ba b--black relative'>
        ...
        <div className='relative absolute-ns top-0 w-100 ph3 tc' style={{ height: '100%' }}>
          ...
          <hgroup className='chicagoflf nsgray'>
            ...
            <h2 className='f5 fw4 mw7 center mv3'>Unlimited<sup>*</sup> storage of NFT data on IPFS, backed by Filecoin and provided free to <a href='https://nfthack.ethglobal.co/' className='white no-underline underline-hover'>NFTHack</a> participants during the hackathon.</h2>
          </hgroup>
        </div>
      </div>
    </div>
